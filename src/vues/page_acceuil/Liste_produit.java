...
public class Liste_produit extends ScrollPane {
	...
	// productList.setGridLinesVisible(true);
        ...
        // On recupere les articles appartenant à la catégorie 'Sport'
    ...
    public Liste_produit(int imgSize, int space, int titleSize, int priceSize, int textSize, AbstractControler controler) {
        this.controler = controler;
	RowConstraints row = new RowConstraints();
	row.setPrefHeight(100);
	row.setVgrow(Priority.ALWAYS);
